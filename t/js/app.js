...
var App = angular.module('singular', ['ngRoute', 'ngAnimate', 'ngStorage', 'ngCookies', 'pascalprecht.translate', 'ui.bootstrap', 'ui.router', 'oc.lazyLoad', 'cfp.loadingBar', 'ui.utils'])
    ...
    $rootScope.user = {
      name:     'Not Logged',
      job:      'None',
      picture:  '//tras.pw/assets/images/guest.png'
    };
...
App.config(['$stateProvider','$urlRouterProvider', '$controllerProvider', '$compileProvider', '$filterProvider', '$provide', '$ocLazyLoadProvider', 'appDependencies',
    function ($stateProvider, $urlRouterProvider, $controllerProvider, $compileProvider, $filterProvider, $provide, $ocLazyLoadProvider, appDependencies) {
      ...
      $stateProvider
        ...
        .state('app.dashboard', {
            url: '/dashboard',
            templateUrl: basepath('dashboard.php'),
            resolve: requireDeps('flot-chart','flot-chart-plugins')
        })
        .state('app.clear-storage', {
            url: '/clear-storage',
            templateUrl: basepath('cstorage.html')
        })
        .state('app.buttons', {
            url: '/buttons',
        ...
        .state('page', {
            url: '/page',
            templateUrl: 't/pages/page.html',
            resolve: requireDeps('icons', 'animate')
        })
        .state('page.login', {
            url: '/login',
            templateUrl: 't/pages/login.php'
        })
        .state('page.logout', {
            url: '/logout',
            templateUrl: 't/pages/logout.php'
        })
        .state('page.register', {
            url: '/register',
            templateUrl: 't/pages/register.php'
        })
        .state('page.recover', {
            url: '/recover',
            templateUrl: 't/pages/recover.php'
        })
        .state('page.lock', {
            url: '/lock',
            templateUrl: 't/pages/lock.html'
        })
        // 
        ...
        function basepath(uri) {
          return 't/views/view.php?name=' + uri;
        }
...
App
  .constant('appDependencies', {
    ...
    scripts: {
      'animate':            ['t/vendor//animate.css/animate.min.css'],
      'icons':              ['t/vendor/fontawesome/css/font-awesome.min.css',
                             't/vendor/weather-icons/css/weather-icons.min.css',
                             't/vendor/feather/webfont/feather-webfont/feather.css'],
      'sparklines':         ['t/js/sparklines/jquery.sparkline.min.js'],
      'slider':             ['t/vendor/seiyria-bootstrap-slider/dist/bootstrap-slider.min.js',
                             't/vendor/seiyria-bootstrap-slider/dist/css/bootstrap-slider.min.css'],
      'wysiwyg':            ['t/vendor/bootstrap-wysiwyg/bootstrap-wysiwyg.js',
                             't/vendor/bootstrap-wysiwyg/external/jquery.hotkeys.js'],
      'slimscroll':         ['t/vendor/slimscroll/jquery.slimscroll.min.js'],
      'screenfull':         ['t/vendor/screenfull/dist/screenfull.min.js'],
      'vector-map':         ['t/vendor/ika.jvectormap/jquery-jvectormap-1.2.2.min.js',
                             't/vendor/ika.jvectormap/jquery-jvectormap-1.2.2.css'],
      'vector-map-maps':    ['t/vendor/ika.jvectormap/jquery-jvectormap-world-mill-en.js',
                             't/vendor/ika.jvectormap/jquery-jvectormap-us-mill-en.js'],
      'loadGoogleMapsJS':   ['t/js/gmap/load-google-maps.js'],
      'flot-chart':         ['t/vendor/Flot/jquery.flot.js'],
      'flot-chart-plugins': ['t/vendor/flot.tooltip/js/jquery.flot.tooltip.min.js',
                             't/vendor/Flot/jquery.flot.resize.js',
                             't/vendor/Flot/jquery.flot.pie.js',
                             't/vendor/Flot/jquery.flot.time.js',
                             't/vendor/Flot/jquery.flot.categories.js',
                             't/vendor/flot-spline/js/jquery.flot.spline.min.js'],
      'jquery-ui':          ['t/vendor/jquery-ui/jquery-ui.min.js',
                             't/vendor/jqueryui-touch-punch/jquery.ui.touch-punch.min.js'],
      'moment' :            ['t/vendor/moment/min/moment-with-locales.min.js'],
      'inputmask':          ['t/vendor/jquery.inputmask/dist/jquery.inputmask.bundle.min.js'],
      'flatdoc':            ['t/vendor/flatdoc/flatdoc.js'],
      'gcal':               ['t/vendor/fullcalendar/dist/gcal.js'],
      'fileinput':          ['t/vendor/fileinput/fileinput.min.css',
                             't/vendor/fileinput/plugins/sortable.min.js',
                             't/vendor/fileinput/plugins/canvas-to-blob.min.js',
                             't/vendor/fileinput/fileinput.min.js']
    },
    // Angular based script (use the right module name)
    modules: [
      {name: 'toaster',           files: ['t/vendor/angularjs-toaster/toaster.js',
                                          't/vendor/angularjs-toaster/toaster.css']},
      {name: 'ui.knob',           files: ['t/vendor/angular-knob/src/angular-knob.js',
                                          't/vendor/jquery-knob/dist/jquery.knob.min.js']},
      {name: 'angularFileUpload', files: ['t/vendor/angular-file-upload/dist/angular-file-upload.min.js']},
      {name: 'angular-chosen',    files: ['t/vendor/chosen_v1.2.0/chosen.jquery.min.js',
                                          't/vendor/chosen_v1.2.0/chosen.min.css',
                                          't/vendor/angular-chosen/angular-chosen.js']},
      {name: 'ngTable',           files: ['t/vendor/ng-table/ng-table.min.js',
                                          't/vendor/ng-table/ng-table.min.css']},
      {name: 'ngTableExport',     files: ['t/vendor/ng-table-export/ng-table-export.js']},
      {name: 'AngularGM',         files: ['t/vendor/AngularGM/angular-gm.min.js']},
      {name: 'ui.calendar',       files: ['t/vendor/fullcalendar/dist/fullcalendar.min.js',
                                          't/vendor/fullcalendar/dist/fullcalendar.css',
                                          't/vendor/angular-ui-calendar/src/calendar.js']}
    ]
...
App.controller('CalendarController', ["$scope", "colors", "$http", "$timeout", "touchDrag", function ($scope, colors, $http, $timeout, touchDrag) {
  ...
  $scope.uiConfig = {
    calendar:{
      googleCalendarApiKey: 'AIzaSyDvz6o7k28ttf03r1A4B7jHWC5AR0V4P4A',
      events: {
            googleCalendarId: 'qeg8jagruipf39onaol7tdnqn4@group.calendar.google.com'
      },
      height: 450,
      editable: true,
      header:{
...
App.controller('MailboxFolderController', ["$scope", "$stateParams", "$state", "appMediaquery", "$window", "$timeout", function($scope, $stateParams, $state, appMediaquery, $window, $timeout) {
  ...
  if( ! $scope.mails[$scope.folder] ) {
    ...
    for(var i =0; i < 10; i++) {
      ...
      m.from.avatar = 't/img/user/0'+(Math.floor((Math.random() * 8))+1)+'.jpg';
...
App.controller('SearchFormController', ["$scope", "$state", function ($scope, $state) {
  ...
  $scope.states = routes.filter(function(item){
    ...
    //var name = item.name.replace("app.", "").replace("page.", "Page - ");
...
App.directive('climacon', function(){
  'use strict';
  var SVG_PATH = 't/vendor/animated-climacons/svgs/',
      SVG_EXT = '.svg';
...
document.addEventListener("DOMContentLoaded", function(event) {
    cookieChoices.showCookieConsentBar("We use cookies to ensure that we give you the best experience on our website. If you continue to use this site we will assume that you are happy with it.", "Ok", "Read more", "https://minelight.ml/help/cookies");
});
