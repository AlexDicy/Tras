...
if (isset($_GET['query'])){
    ...
    $sql = "SELECT 0 AS id, 0 AS content, Members.nick AS nick FROM Members WHERE Members.nick LIKE '%$query%' LIMIT 30
                  UNION
                  SELECT Posts.id, Members.nick, Posts.content FROM Posts JOIN Members ON Posts.user = Members.id WHERE content LIKE '%$query%' LIMIT 30
    ";
