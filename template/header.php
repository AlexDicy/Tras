<header id="navbar" class="<?= Shared::$USERDATA["info"]["st_darkmode"] ? "bg-inverse bg-dark" : "bg-primary" ?>">
        ...
        <div id="navbar-collapse" class="nav-wrapper navbar-collapse collapse" aria-expanded="false" aria-hidden="true" style="height: 0px;">
            ...
            ?>
                <li id="notifications-popup" class="dropdown dropdown-list">
                    ...
                    ?>
                        <li class="bt<?php echo $n['viewed'] == 1 ? (Shared::$USERDATA["info"]["st_darkmode"] ? " bg-inverse bg-dark" : " bg-gray-lighter") . "  viewed" : ""; ?>">
